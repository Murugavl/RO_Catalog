  ...
  return (
    <div className="min-h-screen py-12">
      <div className="container mx-auto px-4">
        <Link to="/models" className="text-blue-600 hover:underline mb-6 inline-block">
          &larr; Back to Models
        </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <h1 className="text-4xl font-bold mb-4">{product.model_name}</h1>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center">
                <span className="text-gray-600 w-32">Technology:</span>
                <span className="font-semibold">{product.technology_type}</span>
              </div>
              <div className="flex items-center">
                <span className="text-gray-600 w-32">Capacity:</span>
            ...
            <div className="space-y-3">
              <h3 className="font-bold text-lg">Contact Us to Buy</h3>
              <button
