  ...
  return (
    <div className="min-h-screen py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-xl md:text-2xl font-bold text-center mb-4 md:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-cyan-500 heading-font">Contact Us</h1>
        <p className="text-center text-sm text-blue-800 mb-12 max-w-2xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 items-stretch">
            <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 flex flex-col h-full items-center text-center">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 flex flex-col h-full items-center text-center w-full">
              ...
              <div className="flex-grow flex items-center justify-center w-full px-2 mb-6" style={{ overflowWrap: 'break-word', wordBreak: 'break-word' }}>
                <p className="text-[17px] font-semibold text-slate-700 text-center w-full">{CONTACT_INFO.email}</p>
              </div>
